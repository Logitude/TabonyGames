...
class CreateMatchForm(forms.Form):
    ...
    player1 = forms.CharField(label='Player1', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    player2 = forms.CharField(label='Player2', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    player3 = forms.CharField(label='Player3', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    player4 = forms.CharField(label='Player4', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    player5 = forms.CharField(label='Player5', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    player6 = forms.CharField(label='Player6', required=False, widget=forms.TextInput(attrs={'placeholder': 'Open'}))
    ...
    resource_remainder_tiebreaker = forms.BooleanField(required=False, label='Resource Remainder as Tiebreaker', initial=True, widget=forms.CheckboxInput(attrs={'class': 'form-check-input'}))
    card_draw_limits = forms.BooleanField(required=False, label='Card Draw Limits', initial=True, widget=forms.CheckboxInput(attrs={'class': 'form-check-input'}))
    korea_nerf = forms.BooleanField(required=False, label='Korea Nerf', initial=True, widget=forms.CheckboxInput(attrs={'class': 'form-check-input'}))
    lincoln_nerf = forms.BooleanField(required=False, label='Lincoln Nerf', initial=True, widget=forms.CheckboxInput(attrs={'class': 'form-check-input'}))
